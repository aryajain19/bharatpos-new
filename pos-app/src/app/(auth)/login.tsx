  ...
  async function handleLogin() {
    ...
    try {
      ...
      if (error.code === 'auth/wrong-password' || error.code === 'auth/invalid-credential') {
        errorMessage = 'Incorrect password. Remember, the default password generated by the Admin Portal is Welcome@123 unless changed.';
    ...
    <View style={styles.formWrapper}>
      ...
      <View style={styles.brandHeader}>
        <View style={styles.logoBadge}>
          <Icon name="rocket-launch" size={26} color="#D81B60" />
        </View>
            ...
            <View style={styles.leftBanner}>
              ...
              <View style={styles.bannerContent}>
                ...
                <View style={styles.bannerBrandRow}>
                  <Icon name="rocket-launch" size={36} color="#D81B60" />
                ...
                <View style={styles.trustFooter}>
                  <Text style={styles.trustText}>
                    Trusted by 12,000+ local retail shops, supermarkets, and apparel hubs across India.
                  </Text>
                </View>
              </View>
            </View>
...
const styles = StyleSheet.create({
  ...
  trustFooter: { marginTop: 60, borderTopWidth: 1, borderTopColor: '#2D3748', paddingTop: 20 },
  trustText: { fontSize: 12, fontStyle: 'italic', lineHeight: 16 },
